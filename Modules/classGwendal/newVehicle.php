...
if( InputSecurity::validateWithoutNumber($_POST['plate']) == $_POST['plate'] 
    && InputSecurity::isEmpty($_POST['model']) == $_POST['model'] 
    && InputSecurity::validateWithoutLetter($_POST['license'], "licensePlate") == $_POST['license'] 
    && InputSecurity::validateWithoutNumber($_POST['maxPassenger']) == $_POST['maxPassenger'] 
