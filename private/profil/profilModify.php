<form action="modifyEmployee" method="post" class="profil-modify-container" enctype="multipart/form-data">
    ...
    <div class="profil-view-user-name disabled input-container width-70">
    ...
    <div class="profil-modify-password input-container width-70">
    ...
    <div class="profil-view-firstname input-container width-70">
    ...
    <div class="profil-view-lastname input-container width-70">
    ...
    <div class="profil-view-fonction <?= addDisabled() ?> input-container width-70">
    ...
    <div class="profil-view-mail-address input-container width-70">
    ...
    <div class="profil-view-phone-number input-container width-70">
    ...
    <div class="profil-modify-btn-zone">
