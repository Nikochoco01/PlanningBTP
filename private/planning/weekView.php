...
<div class="tab" >
    <div class="tabHeader">
        ...
        <div class="changeButtonContent">
            <a href="<?= URLManagement::addUrlParam(array('month'=>$month->previousWeek()->month ,'year'=>$month->previousWeek()->year , 'week'=>$month->previousWeek()->week))?> " class="changeMonth"> <i class="icon-angle-left"></i> </a>
            <a href="<?= URLManagement::addUrlParam(array('month'=>date('m') ,'year'=>date('Y')))?>" class="currentMonth"> <i class="icon-rotate" ></i> </a>
            <a href="<?= URLManagement::addUrlParam(array('month'=>$month->nextWeek()->month ,'year'=>$month->nextWeek()->year , 'week'=>$month->nextWeek()->week))?> " class="changeMonth"> <i class="icon-angle-right"></i> </a>
        </div>
    </div>
