<?php
    require dirname(__FILE__,2). "/class/Month.php";
    require dirname(__FILE__,2). "/class/Events.php";
...
<div class="tab" >
    <div class="tabHeader">
        ...
        <div class="changeButtonContent">
            <a href="<?= URLManagement::addUrlParam(array('month'=>$month->previousMonth()->month ,'year'=>$month->previousMonth()->year))?> " class="changeMonth"> <i class="icon-angle-left"></i> </a>
            <a href="<?= URLManagement::addUrlParam(array('month'=>date('m') ,'year'=>date('Y')))?>" class="currentMonth"> <i class="icon-rotate" ></i> </a>
            <a href="<?= URLManagement::addUrlParam(array('month'=>$month->nextMonth()->month ,'year'=>$month->nextMonth()->year))?> " class="changeMonth"> <i class="icon-angle-right"></i> </a>
        </div>
    </div>
        ...
        <?php for($i = 0 ; $i < $weeks; $i++): ?>
            <tr>
                ...
                ?>
                    ...
                    <?php include dirname(__FILE__). "/boxCalendar.php";?>
                <?php endforeach; ?>
            </tr>
        <?php endfor; ?>
    </table>
